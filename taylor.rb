...
4.times { intro }
8.times { |num| verse_chorus_loop( lyrics_hash[:verse_1_lyrics][num] ) }
8.times { |num| verse_chorus_loop( lyrics_hash[:chorus_lyrics][num] )  }
8.times { |num| verse_chorus_loop( lyrics_hash[:verse_2_lyrics][num] ) }
8.times { |num| verse_chorus_loop( lyrics_hash[:chorus_lyrics][num] )  }
4.times { |num| verse_chorus_loop( lyrics_hash[:outro_lyrics][num] )    }
